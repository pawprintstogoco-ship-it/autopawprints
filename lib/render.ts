...
async function generateAiPortrait(source: Buffer, petName: string) {
  ...
  form.append(
    ...
    [
      ...
      "Do not reinterpret, beautify, cartoonize, or generalize the pet.",
      "Accurately preserve:",
      ...
      "- ear shape, position, and angle",
      "- exact fur markings, patch placement, and asymmetry",
      "- accurate fur color distribution and transitions",
      ...
      "Preserve detail in the eyes, nose, muzzle, fur direction, and major fur transitions.",
      "Keep the illustration clean and graphic, but do NOT oversimplify the pet into generic shapes.",
      "This should feel like high-end custom portrait artwork, not a cartoon and not a flat logo.",
      "",
      ...
      "- no soft blurry airbrush effect",
